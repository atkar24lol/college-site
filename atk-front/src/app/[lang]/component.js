      ...
      >
        ...
        <Container className="relative py-10 sm:py-16 md:py-20 lg:py-24">
          <div className="grid items-center gap-10 lg:grid-cols-[minmax(0,1fr)_auto] lg:gap-16">
            <div className="order-last min-w-0 max-w-3xl text-center lg:order-none lg:text-left">
              {kicker ? (
              ...
              <p className="mx-auto mt-5 max-w-xl text-sm leading-relaxed text-neutral-600 sm:mt-6 sm:text-base md:text-lg lg:mx-0">
                {h?.descriptions?.main}
              </p>
            ...
            <div className="order-first flex justify-center lg:order-none lg:justify-end">
              <div className="relative flex items-center justify-center">
                <div
                  aria-hidden
                  className="absolute h-[115%] w-[115%] rounded-full bg-[var(--color-accent-soft)] opacity-60 blur-2xl"
                />
                <Image
                  src="/atk-logo.png"
                  alt="Эмблема Агротехнического колледжа имени Султана Ибраимова"
                  width={320}
                  height={320}
                  priority
                  sizes="(max-width: 1023px) 144px, 320px"
                  className="relative h-32 w-32 object-contain drop-shadow-sm sm:h-36 sm:w-36 lg:h-[20rem] lg:w-[20rem]"
                />
              </div>
            </div>
          </div>
